...
<div className={slide.type === 'image' ? 'fixed inset-0 pointer-events-auto' : 'w-full md:w-auto max-w-4xl px-6 md:px-0 pointer-events-auto'}>
  {slide.type === 'text' && (
  <div
    className={`text-white/70 leading-relaxed whitespace-pre-wrap text-lg md:text-xl lg:text-2xl w-full overflow-hidden wrap-break-word max-h-[80vh] overflow-y-auto md:max-h-none md:overflow-visible`} style={{ fontFamily: 'isocpeur, monospace' }}
  >
    {slide.title && (
  ...
  <div className="flex flex-col md:flex-row gap-12 md:gap-16 lg:gap-20 items-center max-w-5xl justify-center pointer-events-auto h-full">
    ...
    <div className="text-white/70 leading-relaxed whitespace-pre-wrap text-lg md:text-xl lg:text-2xl max-w-lg lg:max-w-xl flex flex-col justify-center">
      {slide.title && (
        <div className="text-xl md:text-2xl lg:text-3xl mb-4" style={{ fontFamily: 'isocpeur' }}>
          {slide.title}
        </div>
      )}
    <div style={{ fontFamily: 'isocpeur, monospace' }}
